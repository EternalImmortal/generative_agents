...
class Maze:
    def __init__(self, maze_name):
        ...
        # 在迷宫中完成加载后，我们现在设置 self.tiles。这是一个由 row：col 访问的矩阵，
        # 其中每个接入点都是一个字典，其中包含该磁贴中发生的所有事情。
        # 更具体地说，它包含有关其“世界”、“扇区”、“竞技场”、“game_object”、“spawning_location”的信息，
        # 以及它是否是碰撞块，以及其中发生的所有事件的集合。
        ...
        # 给定一个字符串地址,我们返回一组属于该地址的所有磁贴坐标(这与self.tiles相反,self.tiles给出了给定坐标的字符串地址)。
